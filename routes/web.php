...
Route::get('story/{id}', [App\Http\Controllers\HomeController::class, 'story'])->name('story');
...
#story
Route::get('dashboard/story/insert/page', [App\Http\Controllers\StoryController::class, 'insert_page']);
Route::post('dashboard/story/insert/function', [App\Http\Controllers\StoryController::class, 'insert_function']);
Route::get('dashboard/story/loop', [App\Http\Controllers\StoryController::class, 'loop']);
Route::get('dashboard/story/edit/page/{id}', [App\Http\Controllers\StoryController::class, 'update_page']);
Route::post('dashboard/story/edit/function/{id}', [App\Http\Controllers\StoryController::class, 'update_function']);
Route::get('dashboard/story/remove/{id}', [App\Http\Controllers\StoryController::class, 'remove_function']);