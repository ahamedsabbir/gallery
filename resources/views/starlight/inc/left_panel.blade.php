...
<div class="sl-sideleft">
  ...
  <div class="sl-sideleft-menu">
	...
	<a href="#" class="sl-menu-link">
	  <div class="sl-menu-item">
		<i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
		<span class="menu-item-label">Story</span>
		<i class="menu-item-arrow fa fa-angle-down"></i>
	  </div><!-- menu-item -->
	</a><!-- sl-menu-link -->
	<ul class="sl-menu-sub nav flex-column">
	  <li class="nav-item"><a href="{{ url('dashboard/story/insert/page') }}" class="nav-link">Insert</a></li>
	  <li class="nav-item"><a href="{{ url('dashboard/story/loop') }}" class="nav-link">Loop</a></li>
	</ul>
